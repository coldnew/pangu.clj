(defproject online-demo "0.1.0-SNAPSHOT"
  :description "Online Demo for pangu.clj"
  :author "Yen-Chin, Lee"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "online-demo.core/on-figwheel-reload"}

                :compiler {:main online-demo.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/online-demo.js"
